import torch
from mat.algorithms.mat.actor_critic import Actor, Critic
...
class HAPPO_Policy:
    ...
    def act(self, obs, rnn_states_actor, masks, available_actions=None, deterministic=False):
        ...
        :param deterministic: (bool) whether the action should be mode of distribution or should be sampled.
        """
        actions, _, rnn_states_actor, action_logits = self.actor(obs, rnn_states_actor, masks, available_actions,
                                                                 deterministic)
