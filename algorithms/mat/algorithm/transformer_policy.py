...
class TransformerPolicy:
    ...
    def get_actions(self, cent_obs, obs, rnn_states_actor, rnn_states_critic, masks, available_actions=None,
        ...
        actions, action_log_probs, values, action_logits = self.transformer.get_actions(cent_obs,
                                                                         obs,
                                                                         available_actions,
                                                                         deterministic)
    ...
    def act(self, cent_obs, obs, rnn_states_actor, masks, available_actions=None, deterministic=True):
        ...
        _, actions, _, rnn_states_actor, _, action_logits = self.get_actions(cent_obs,
                                                              obs,
                                                              rnn_states_actor,
                                                              rnn_states_critic,
                                                              masks,
